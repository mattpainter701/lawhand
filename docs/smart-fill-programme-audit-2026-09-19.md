...
| 4c/4d | Verification persisted per session; readiness record counts | Shipped | CHANGELOG 2026.09.20.04 | session `verified` round trip; `verified_counts` test; banner shows verified |
