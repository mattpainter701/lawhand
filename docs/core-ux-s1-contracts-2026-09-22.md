...
| --- | --- | --- | --- |
| `GET /matters/my` | Hard `limit(100)`, no `total` | `page`, `page_size`, `total` = matching permitted records before pagination; stable order (`updated_at desc`, `id` tie-break); assignment scope | S3.01, S3.02 |
