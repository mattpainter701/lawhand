...
class Tenant(Base):
    ...
    platform_billing_provider: Mapped[str | None] = mapped_column(String(20), nullable=True)
    platform_customer_id: Mapped[str | None] = mapped_column(String(100), nullable=True)
    platform_subscription_status: Mapped[str | None] = mapped_column(String(40), nullable=True)
