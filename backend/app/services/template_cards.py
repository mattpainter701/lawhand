    ...
    Card(
        ...
        fields=(
            ...
            CardField(
                ...
                "Matter number",
                alias="matter_number",
                legacy_path="matter.number",
            ),
            CardField(
                "practice_area",
                "Practice area",
                alias="practice_area",
                legacy_path="matter.practice_area",
            ),
            CardField(
                "opened_on",
                "Date opened",
    ...
    Card(
        ...
        fields=(
            ...
            CardField(
                "first_name",
                "First name",
                alias="client_first_name",
                legacy_path="client.first_name",
            ),
            CardField(
                "last_name",
                "Last name",
                alias="client_last_name",
                legacy_path="client.last_name",
            ),
            CardField(
                "preferred_name",
                "Preferred name",
                alias="client_preferred_name",
                legacy_path="client.preferred_name",
            ),
            CardField(
                "organization_name",
                "Organization name",
                alias="client_organization_name",
                legacy_path="client.organization_name",
            ),
            CardField(
                "entity_type",
                "Entity type (person or organization)",
                alias="client_entity_type",
                legacy_path="client.entity_type",
            ),
            CardField(
                "client_number",
                "Client number",
                alias="client_number",
                legacy_path="client.client_number",
            ),
            CardField(
                "email",
                "Client email",
            ...
            CardField(
                ...
                alias="client_date_of_birth",
                legacy_path="client.date_of_birth",
            ),
            CardField(
                "secondary_phone",
                "Client secondary phone",
                alias="client_secondary_phone",
                legacy_path="client.secondary_phone",
            ),
            CardField(
                "preferred_contact_method",
                "Preferred contact method",
                alias="client_preferred_contact_method",
                legacy_path="client.preferred_contact_method",
            ),
            CardField(
                "preferred_contact_window",
                "Best time to reach the client",
                alias="client_preferred_contact_window",
                legacy_path="client.preferred_contact_window",
            ),
            CardField(
                "preferred_language",
                "Preferred language",
                alias="client_preferred_language",
                legacy_path="client.preferred_language",
            ),
            CardField(
                "referral_source",
                "How the client found the firm",
                alias="client_referral_source",
                legacy_path="client.referral_source",
            ),
            # One JSON column on the contact, addressed per key.
            CardField(
                "emergency_contact_name",
                "Emergency contact name",
                alias="emergency_contact_name",
                legacy_path="client.emergency_contact.name",
            ),
            CardField(
                "emergency_contact_relationship",
                "Emergency contact relationship",
                alias="emergency_contact_relationship",
                legacy_path="client.emergency_contact.relationship",
            ),
            CardField(
                "emergency_contact_phone",
                "Emergency contact phone",
                alias="emergency_contact_phone",
                legacy_path="client.emergency_contact.phone",
            ),
            CardField(
                "emergency_contact_email",
                "Emergency contact email",
                alias="emergency_contact_email",
                legacy_path="client.emergency_contact.email",
            ),
        ),
    ),
    _role_card("plaintiff", "Plaintiff"),
    _role_card("defendant", "Defendant"),
    _role_card("petitioner", "Petitioner"),
    _role_card("respondent", "Respondent"),
    _role_card("opposing_party", "Opposing party"),
    _role_card("counsel", "Counsel"),
    _role_card("witness", "Witness"),
    _role_card("expert", "Expert"),
    Card(
        key="attorney",
