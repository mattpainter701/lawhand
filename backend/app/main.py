...
from app.routers.commercial_pricing import router as commercial_pricing_router
...
from app.routers.fill_sessions import router as fill_sessions_router
...
from app.routers.automation_services import router as automation_services_router
...
app.include_router(fill_sessions_router, prefix="/api")
...
app.include_router(commercial_pricing_router, prefix="/api")
...
app.include_router(automation_services_router)
                ...
                (
                    await session.execute(
                        text(
                            ...
                            "WHERE is_active "
                            "AND billing_tier NOT IN ('demo', 'fixture') "
                            "ORDER BY id"
                        )
                    )
                ).scalars()
