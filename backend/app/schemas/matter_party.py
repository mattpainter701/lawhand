...
MATTER_PARTY_ROLE_DEFINITIONS: tuple[dict[str, object], ...] = (
    ...
    },
    {
        ...
        "is_caption_role": True,
        "template_fields": ["petitioner_name", "petitioner_names"],
    },
    {
        "value": "respondent",
        "label": "Respondent",
        ...
        "is_caption_role": True,
        "template_fields": ["respondent_name", "respondent_names"],
    },
    {
        "value": "client",
        "label": "Client",
    ...
    },
    {
        ...
        "is_caption_role": False,
        "template_fields": ["opposing_party_name", "opposing_party_names"],
    },
    {
        "value": "counsel",
        "label": "Counsel",
        ...
        "is_caption_role": False,
        "template_fields": ["counsel_name", "counsel_names"],
    },
    {
        "value": "witness",
        "label": "Witness",
        ...
        "is_caption_role": False,
        "template_fields": ["witness_name", "witness_names"],
    },
    {
        "value": "expert",
        "label": "Expert",
        ...
        "is_caption_role": False,
        "template_fields": ["expert_name", "expert_names"],
    },
    {
        "value": "other",
        "label": "Other",
