...
export default function MatterDocumentsTab({ matterId, onCloudFolderChange, onReviseDocument, onPrepareTemplate }) {
  ...
  // The preview keeps the row it was opened with; the edit controls follow the
  // list so "being edited" and brought-back versions show up in the preview
  // a saved document lands on.
  const livePreviewDocument = previewDocument
    ? docs.find((doc) => doc.id === previewDocument.id) || previewDocument
    : null
