  ...
  return <fieldset className="mt-4 rounded-xl border border-brand-line p-4">
    ...
    {schedule ? <div className="mt-3 text-sm">
      ...
      <div className="mt-3 grid gap-3 sm:grid-cols-3">
        <label className="text-sm">First recurring invoice date<input type="date" className="min-h-11 rounded-xl border border-brand-line bg-brand-surface px-3 text-sm text-brand-ink focus:outline-none focus:ring-2 focus:ring-brand-accent w-full" value={firstDate} onChange={e => setFirstDate(e.target.value)} /></label>
        <label className="text-sm">End date (optional)<input type="date" className="min-h-11 rounded-xl border border-brand-line bg-brand-surface px-3 text-sm text-brand-ink focus:outline-none focus:ring-2 focus:ring-brand-accent w-full" min={firstDate} value={endDate} onChange={e => setEndDate(e.target.value)} /></label>
        <label className="text-sm">Frequency<select className="min-h-11 rounded-xl border border-brand-line bg-brand-surface px-3 text-sm text-brand-ink focus:outline-none focus:ring-2 focus:ring-brand-accent w-full" value={months} onChange={e => setMonths(e.target.value)}><option value="1">Monthly</option><option value="3">Quarterly</option></select></label>
        <label className="text-sm">Timezone<input className="min-h-11 rounded-xl border border-brand-line bg-brand-surface px-3 text-sm text-brand-ink focus:outline-none focus:ring-2 focus:ring-brand-accent w-full" value={zone} onChange={e => setZone(e.target.value)} /></label>
        <label className="text-sm">Recurring fee description<input className="min-h-11 rounded-xl border border-brand-line bg-brand-surface px-3 text-sm text-brand-ink focus:outline-none focus:ring-2 focus:ring-brand-accent w-full" value={description} onChange={e => setDescription(e.target.value)} /></label>
        <label className="text-sm">Recurring fixed amount<input type="number" className="min-h-11 rounded-xl border border-brand-line bg-brand-surface px-3 text-sm text-brand-ink focus:outline-none focus:ring-2 focus:ring-brand-accent w-full" min="0" step="0.01" value={amount} onChange={e => setAmount(e.target.value)} /></label>
      </div>
