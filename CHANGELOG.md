...
- Tests: `unit/test_probate_determination.py` (17), `unit/test_probate_facts.py`, `unit/test_probate_deadlines.py`, `unit/test_probate_bindings.py`, `unit/test_build_nd_probate_guidebook.py`, `test_nd_probate_forms.py`, `test_intake_typed_answers.py`, `test_probate_routes_postgres.py`, `test_probate_smart_fill.py`, `test_client_portal_estate.py`, a write-back preview case, and Vitest for `ProbateTab`, `ClientIntakeChecklist`, `ClientPortalEstateTab`, `IntakeSetupFields`, `EstateDetailPage`.
