## 2026.09.24.03 — Fill sample forms on the document
...
- `hasFillValue`, `isFieldRequired` and `orderFieldsForDocument` are exported from `FillOnDocument.jsx` for the Prepare/Generate rollout described in `docs/document-fill-ux-plan-2026-09-24.md`.
